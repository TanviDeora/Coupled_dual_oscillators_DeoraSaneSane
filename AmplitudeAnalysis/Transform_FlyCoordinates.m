function [pointsInFlyCoordinates, bodyparts, experiment, u] = Transform_FlyCoordinates(data, path_for_data_org_file)
...
t.Properties.VariableNames = {'mode', 'treatment'};
newTable = table(t.treatment, 'RowNames', t.mode);
% newTable = table(t.asym, 'RowNames', t.mode);
% newTable = table(t.halt, 'RowNames', t.mode);
